...
const file_internal_registry_pb_test_proto_rawDesc = "" +
	"\n" +
	"\x1finternal/registry/pb/test.proto\x12\n" +
	"testprotos\"\x14\n" +
	"\bMessage1*\b\b\n" +
	...
	"\rmessage_field\x12\x14.testprotos.Message1\x18\r \x01(\v2\x14.testprotos.Message2R\fmessageFieldB\x0eZ\f.;testprotos"
