...
func (m *InitResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Last != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Last))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *New) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.At != 0 {
		i = encodeVarint(dAtA, i, uint64(m.At))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Meta) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LocalVersion != 0 {
		i = encodeVarint(dAtA, i, uint64(m.LocalVersion))
		i--
		dAtA[i] = 0x10
	}
	if m.GRPCPort != 0 {
		i = encodeVarint(dAtA, i, uint64(m.GRPCPort))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Meta) SizeVT() (n int) {
	...
	_ = l
	if m.GRPCPort != 0 {
		n += 1 + sov(uint64(m.GRPCPort))
	}
	if m.LocalVersion != 0 {
		n += 1 + sov(uint64(m.LocalVersion))
	}
	if m.IsLeader {
		n += 2
	}
