...
var ProtoDBMethods = struct {
	...
	Get:             "/linka.cloud.protodb.v1alpha1.ProtoDB/Get",
	Set:             "/linka.cloud.protodb.v1alpha1.ProtoDB/Set",
	Delete:          "/linka.cloud.protodb.v1alpha1.ProtoDB/Delete",
	Tx:              "/linka.cloud.protodb.v1alpha1.ProtoDB/Tx",
	NextSeq:         "/linka.cloud.protodb.v1alpha1.ProtoDB/NextSeq",
	Lock:            "/linka.cloud.protodb.v1alpha1.ProtoDB/Lock",
	Watch:           "/linka.cloud.protodb.v1alpha1.ProtoDB/Watch",
	Register:        "/linka.cloud.protodb.v1alpha1.ProtoDB/Register",
	Descriptors:     "/linka.cloud.protodb.v1alpha1.ProtoDB/Descriptors",
	FileDescriptors: "/linka.cloud.protodb.v1alpha1.ProtoDB/FileDescriptors",
}
...
var NextSeqRequestFields = struct {
	Key string
}{
	Key: "key",
}

var NextSeqResponseFields = struct {
	Seq string
}{
	Seq: "seq",
}
