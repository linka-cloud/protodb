...
func (m *OrderBy) CloneVT() *OrderBy {
	if m == nil {
		return (*OrderBy)(nil)
	}
	r := new(OrderBy)
...
func (m *OrderBy) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *GetRequest) EqualVT(that *GetRequest) bool {
	...
	if !this.OrderBy.EqualVT(that.OrderBy) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *OrderBy) EqualVT(that *OrderBy) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *OrderBy) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*OrderBy)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *GetRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.OrderBy != nil {
		size, err := m.OrderBy.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *OrderBy) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *OrderBy) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *OrderBy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *GetRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if err := m.OrderBy.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *OrderBy) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
