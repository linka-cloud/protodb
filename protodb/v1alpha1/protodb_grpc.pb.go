...
const (
	ProtoDB_Get_FullMethodName             = "/linka.cloud.protodb.v1alpha1.ProtoDB/Get"
	ProtoDB_Set_FullMethodName             = "/linka.cloud.protodb.v1alpha1.ProtoDB/Set"
	ProtoDB_Delete_FullMethodName          = "/linka.cloud.protodb.v1alpha1.ProtoDB/Delete"
	ProtoDB_Tx_FullMethodName              = "/linka.cloud.protodb.v1alpha1.ProtoDB/Tx"
	ProtoDB_NextSeq_FullMethodName         = "/linka.cloud.protodb.v1alpha1.ProtoDB/NextSeq"
	ProtoDB_Lock_FullMethodName            = "/linka.cloud.protodb.v1alpha1.ProtoDB/Lock"
	ProtoDB_Watch_FullMethodName           = "/linka.cloud.protodb.v1alpha1.ProtoDB/Watch"
	ProtoDB_Register_FullMethodName        = "/linka.cloud.protodb.v1alpha1.ProtoDB/Register"
	ProtoDB_Descriptors_FullMethodName     = "/linka.cloud.protodb.v1alpha1.ProtoDB/Descriptors"
	ProtoDB_FileDescriptors_FullMethodName = "/linka.cloud.protodb.v1alpha1.ProtoDB/FileDescriptors"
)
...
var ProtoDB_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "linka.cloud.protodb.v1alpha1.ProtoDB",
	...
	Metadata: "protodb/v1alpha1/protodb.proto",
}
