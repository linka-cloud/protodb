...
func (m *SetRequest) CloneVT() *SetRequest {
	...
	if rhs := m.TTL; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *durationpb.Duration }); ok {
			...
			r.TTL = proto.Clone(rhs).(*durationpb.Duration)
		}
	}
	if rhs := m.FieldMask; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *fieldmaskpb.FieldMask }); ok {
			...
			r.FieldMask = proto.Clone(rhs).(*fieldmaskpb.FieldMask)
		}
	}
...
func (m *SetResponse) CloneVT() *SetResponse {
	...
	if rhs := m.Result; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *anypb.Any }); ok {
			...
			r.Result = proto.Clone(rhs).(*anypb.Any)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *GetRequest) CloneVT() *GetRequest {
	...
	r := &GetRequest{
		Paging: m.Paging.CloneVT(),
	}
	if rhs := m.Search; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *anypb.Any }); ok {
			r.Search = vtpb.CloneVT()
		} else {
			r.Search = proto.Clone(rhs).(*anypb.Any)
		}
	}
...
func (m *TxRequest_Commit) CloneVT() isTxRequest_Request {
	...
	if rhs := m.Commit; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *wrapperspb.BoolValue }); ok {
			...
			r.Commit = proto.Clone(rhs).(*wrapperspb.BoolValue)
		}
	}
	return r
}
...
func (m *CommitResponse) CloneVT() *CommitResponse {
	...
	if rhs := m.Error; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface {
			...
			r.Error = proto.Clone(rhs).(*wrapperspb.StringValue)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *WatchEvent) CloneVT() *WatchEvent {
	...
	if rhs := m.Old; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *anypb.Any }); ok {
			r.Old = vtpb.CloneVT()
		} else {
			r.Old = proto.Clone(rhs).(*anypb.Any)
		}
	}
	if rhs := m.New; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *anypb.Any }); ok {
			r.New = vtpb.CloneVT()
		} else {
			r.New = proto.Clone(rhs).(*anypb.Any)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *FieldDiff) CloneVT() *FieldDiff {
	...
	if rhs := m.From; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *structpb.Value }); ok {
			...
			r.From = proto.Clone(rhs).(*structpb.Value)
		}
	}
	if rhs := m.To; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *structpb.Value }); ok {
			...
			r.To = proto.Clone(rhs).(*structpb.Value)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (this *SetRequest) EqualVT(that *SetRequest) bool {
	...
	if equal, ok := interface{}(this.TTL).(interface {
		EqualVT(*durationpb.Duration) bool
	}); ok {
		if !equal.EqualVT(that.TTL) {
			return false
		}
	} else if !proto.Equal(this.TTL, that.TTL) {
		return false
	}
...
func (this *SetResponse) EqualVT(that *SetResponse) bool {
	...
	if equal, ok := interface{}(this.Result).(interface{ EqualVT(*anypb.Any) bool }); ok {
...
func (this *GetRequest) EqualVT(that *GetRequest) bool {
	...
	if equal, ok := interface{}(this.Search).(interface{ EqualVT(*anypb.Any) bool }); ok {
		if !equal.EqualVT(that.Search) {
			return false
		}
	} else if !proto.Equal(this.Search, that.Search) {
		return false
	}
...
func (this *CommitResponse) EqualVT(that *CommitResponse) bool {
	...
	if equal, ok := interface{}(this.Error).(interface {
...
func (this *WatchEvent) EqualVT(that *WatchEvent) bool {
	...
	if equal, ok := interface{}(this.Old).(interface{ EqualVT(*anypb.Any) bool }); ok {
		if !equal.EqualVT(that.Old) {
			return false
		}
	} else if !proto.Equal(this.Old, that.Old) {
		return false
	}
	if equal, ok := interface{}(this.New).(interface{ EqualVT(*anypb.Any) bool }); ok {
		if !equal.EqualVT(that.New) {
			return false
		}
	} else if !proto.Equal(this.New, that.New) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *FieldDiff) EqualVT(that *FieldDiff) bool {
	...
	if equal, ok := interface{}(this.From).(interface{ EqualVT(*structpb.Value) bool }); ok {
		if !equal.EqualVT(that.From) {
			return false
		}
	} else if !proto.Equal(this.From, that.From) {
		return false
	}
	if equal, ok := interface{}(this.To).(interface{ EqualVT(*structpb.Value) bool }); ok {
		if !equal.EqualVT(that.To) {
			return false
		}
	} else if !proto.Equal(this.To, that.To) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *GetRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Search != nil {
		if vtmsg, ok := interface{}(m.Search).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *WatchEvent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.New != nil {
		if vtmsg, ok := interface{}(m.New).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.Old != nil {
		if vtmsg, ok := interface{}(m.Old).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *FieldDiff) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.To != nil {
		if vtmsg, ok := interface{}(m.To).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
